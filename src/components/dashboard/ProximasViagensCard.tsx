...
export const ProximasViagensCard = ({
  ...
  return <Card className="overflow-hidden border shadow-lg bg-white dark:bg-gray-800">
      ...
      <CardContent className="pt-6">
        {isLoading ? <div className="flex items-center justify-center py-4">
          ...
          </div> : proximasViagens.length > 0 ? <div className="space-y-5">
            {proximasViagens.map(viagem => <div key={viagem.id} className="flex items-center justify-between border-b pb-4 last:border-0">
