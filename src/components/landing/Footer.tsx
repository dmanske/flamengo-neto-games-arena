    ...
    <div className="container mx-auto px-4 py-12">
        ...
        <div className="md:col-span-2">
          <div className="mb-4 text-center md:text-left">
            <img
              src={netoToursLogo}
              alt="Neto Tours"
              className="h-32 w-auto object-contain mx-auto md:mx-0"
            />
            <h3 className="text-2xl font-bold text-white mt-2">
              Neto Tours Viagens
            </h3>
          </div>
          <p className="text-gray-400 mb-4 max-w-md italic text-center md:text-left">
      ...
      <div className="border-t border-gray-900 pt-8 text-center text-gray-400 text-sm">
        ...
        <p className="mt-1">
          Desenvolvido por{" "}
          <a
            href="mailto:daniel.manske@gmail.com"
