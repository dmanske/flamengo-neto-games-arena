-- =====================================================
-- SISTEMA DE CONFIRMAÇÃO DE PRESENÇA VIA QR CODE
-- =====================================================
...
-- 3. ADICIONAR CAMPOS NA TABELA DE PASSAGEIROS
-- =====================================================
...
-- 4. CRIAR TRIGGER PARA ATUALIZAR CONFIRMAÇÃO
-- =====================================================
...
-- Função para gerar tokens para uma viagem
...
BEGIN
  ...
  -- Calcular expiração (24h após o jogo)
...
-- Função para buscar informações do token
...
BEGIN
  ...
  RAISE NOTICE '   1. Vá para uma viagem no sistema';
  RAISE NOTICE '   2. Procure pela aba "QR Codes"';
  RAISE NOTICE '   3. Clique em "Gerar QR Codes"';
  RAISE NOTICE '   4. Envie via WhatsApp ou baixe os códigos';
  RAISE NOTICE '';
